...
public class DriverBigData extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		// Define a personalized "parameter" that is used to send the input
		// threshold to the mappers of this application
		// Pay attention to set properties before instantiating the Job object 
