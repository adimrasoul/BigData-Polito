...
public class SparkDriver {
	...
	public static void main(String[] args) {
		...
		//take the top k 
		List<Tuple2<Integer,String>> topFinalResult = sortedFinalResult.take(k);

		//save
		//System.out.println(topFinalResult);
		JavaPairRDD<Integer,String> finalresult = sc.parallelizePairs(topFinalResult);
